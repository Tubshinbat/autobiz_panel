...
const Add = (props) => {
  ...
  const init = () => {
    props.clear();
    props.getPrice(props.match.params.id);
  };
  ...
  const addClick = () => {
    ...
    allCheck() === true
      ? props.updatePrice(props.match.params.id, sendData)
...
const mapDispatchToProps = (dispatch) => {
  return {
    updatePrice: (id, data) => dispatch(actions.updatePrice(id, data)),
    getPrice: (id) => dispatch(actions.getPrice(id)),
