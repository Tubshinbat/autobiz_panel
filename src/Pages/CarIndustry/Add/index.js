...
const Add = (props) => {
  ...
  useEffect(() => {
    if (props.success) {
      ...
      props.clear();
      setTimeout(() => props.history.replace("/industry"), 2000);
    }
  }, [props.success]);
  ...
  const addClick = () => {
    ...
    allCheck() === true
      ? props.createCarindustry(sendData)
  ...
  return (
    <Section>
      <MetaTags>
        <title> Машины үйлдвэр нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Машины үйлдвэр нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Машины үйлдвэр нэмэх | web control panel"
        />
      </MetaTags>

      <PageTitle name={`Машины үйлдвэр нэмэх `} />
      <div className="row">
            ...
            <div className={`${css.AddForm} row`}>
              <div className="col-md-12">
                <div className="form-group input-group-sm">
                  <p className={`${css.Title}`}> Машины үйлдвэр {useCookies}</p>
                  <input
                    className="form-control"
                    type="text"
                    name="name"
                    placeholder="Машины үйлдвэрийн  оруулна уу"
                    value={formData.name}
          ...
          <div className="card card-primary card-outline">
            <div className="card-header">
              <h3 className="card-title">
                <i className="far fa-image"></i> Машины үйлдвэрийн зураг
              </h3>
            </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    createCarindustry: (news) => dispatch(actions.createCarindustry(news)),
