...
const News = (props) => {
  ...
  const init = () => {
    ...
    setChkBox(() => []);
    props.clear();
    props.loadCarindustrys(`select=${select}`);
  };

  const addClick = () => {
    props.history.push("/industry/add");
  };
  ...
  const deleteClick = () => {
    ...
    props.deleteMultCarindustry(ids);
    setDeleteModel(false);
  };
  ...
  return (
    <Section>
      <MetaTags>
        <title> Машины үйлдвэр | WEBR Control Panel</title>
        <meta
          name="description"
          content="Машины үйлдвэр | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Машины үйлдвэр | web control panel"
        />
      </MetaTags>
      <PageTitle name="Машины үйлдвэр" />
      <div className="row">
        <div className={css.PanelControl}>
          <div className="col-md-4">
            <div className={css.PanelTabelHeader}>
              ...
              >
                <i className="fas fa-plus-circle"></i> Машины үйлдвэр
              </button>
              <button
                name="refresh"
                onClick={() => init()}
...
const mapStateToProps = (state) => {
  return {
    ...
    pageLast: state.carIndustryReducer.paginationLast,
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    loadCarindustrys: (query) => dispatch(actions.loadCarindustrys(query)),
    loadPagination: (pageLast) => dispatch(actions.loadPagination(pageLast)),
    deleteMultCarindustry: (ids) =>
      dispatch(actions.deleteMultCarindustry(ids)),
  };
};
