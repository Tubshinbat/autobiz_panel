...
const Add = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Бэлэн машины захиалга нэмэх | WEBR Control Panel</title>
        <meta
          name="description"
          content="Бэлэн машины захиалга нэмэх | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Бэлэн машины захиалга нэмэх | web control panel"
        />
      </MetaTags>

      <PageTitle name={`Бэлэн машины захиалга нэмэх `} />
      <div className="row">
              ...
              <div className="col-md-12">
                <div className="form-group input-group-sm">
                  <p className={`${css.Title}`}>
                    {" "}
                    Бэлэн машины захиалга {useCookies}
                  </p>
                  <input
                    className="form-control"
                    type="text"
                    name="name"
                    placeholder="Бэлэн машины захиалгаийн  оруулна уу"
                    value={formData.name}
          ...
          <div className="card card-primary card-outline">
            <div className="card-header">
              <h3 className="card-title">
                <i className="far fa-image"></i> Бэлэн машины захиалгаийн зураг
              </h3>
            </div>
