...
const News = (props) => {
  ...
  return (
    <Section>
      <MetaTags>
        <title> Бэлэн машины захиалга | WEBR Control Panel</title>
        <meta
          name="description"
          content="Бэлэн машины захиалга | WeBR control panel"
        />
        <meta
          property="og:title"
          content="Бэлэн машины захиалга | web control panel"
        />
      </MetaTags>
      <PageTitle name={`Бэлэн машины захиалга`} />
                  ...
                  props.orders.map((el) => (
                    <tr key={el._id}>
                      ...
                      <td>
                        {el.product_id && (
                          <a
                            href={`${myBase.siteUrl}product/${el.product_id._id}`}
                            target="_blank"
                          >
                            {el.product_id.title}
                          </a>
