...
const Add = (props) => {
  ...
  const orderHandle = (event) => {
    ...
    const sendData = new FormData();
    sendData.append("orderType", value);
    ...
    <Section>
      ...
      <div className="row">
                    ...
                    <div className="col-md-4">
                      <div className="productImage">
                        {props.order.product_id &&
                          props.order.product_id.pictures && (
                            <img
                              src={`${base.cdnUrl}uploads/${props.order.product_id.pictures[0]}`}
                            />
                          )}
                      </div>
                    </div>
                    <div className="col-md-8">
                      <div className="productDetails">
                        ...
                        <div className="productField">
                          {props.order.product_id && (
                            <a
                              href={`${base.siteUrl}product/${props.order.product_id._id}`}
                              target="_blank"
                            >
                              Машины дэлгэрэнгүй
                            </a>
        ...
        <div className="col-md-4">
          ...
          <div className="card card-primary card-outline">
            <div className="card-header">
              <h3 className="card-title">Төлөв</h3>
            </div>
            <div className="card-body box-profile">
              <select
              ...
              >
                ...
                {props.orderTypes &&
                  props.orderTypes.map((orderType) => (
                    <option value={orderType._id}>{orderType.name}</option>
                  ))}
              </select>{" "}
            </div>
          </div>
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    update: (id, data) => dispatch(actions.updateOrder(id, data)),
